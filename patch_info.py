with open("src/components/hocfdc/CurriculumBriefInfo.tsx", "r", encoding="utf-8") as f:
    text = f.read()
...
with open("src/components/hocfdc/CurriculumBriefInfo.tsx", "w", encoding="utf-8") as f:
    f.write(text)
