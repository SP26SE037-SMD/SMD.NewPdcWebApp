...
export class SessionService {
    ...
    static async validateSessionType(syllabusId: string, payload: any[]) {
        return apiClient.post<any>(`/api/sessions/syllabus/${syllabusId}/validate-session-type`, payload);
    }
