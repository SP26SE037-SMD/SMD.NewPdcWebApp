...
const MOCK_CREATED_REQUESTS: RequestItem[] = [
  {
    ...
    createdBy: {
      accountId: "user-1",
      fullName: "HoCFDC User",
      email: "hocfdc@fpt.edu.vn",
    },
    major: {
      majorId: "m-se",
      majorCode: "SE",
...
const MOCK_RECEIVED_REQUESTS: RequestItem[] = [
  ...
  },
  {
    ...
    content: "Syllabus details for new AI foundational course. Requires HoCFDC review and approval before sprint completion.",
    status: "PENDING",
    ...
    try {
      ...
      const newRequest: RequestItem = {
        ...
        createdBy: {
          ...
          fullName: user.fullName || "HoCFDC User",
          email: user.email || "hocfdc@fpt.edu.vn",
        },
        major: selectedMajor
          ? {
