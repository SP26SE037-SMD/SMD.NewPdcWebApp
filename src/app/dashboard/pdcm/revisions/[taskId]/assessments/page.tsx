                                                    ...
                                                    return (
                                                        <React.Fragment key={idx}>
                                                            <tr className="hover:bg-primary/5 transition-colors">
                                                                ...
                                                                <td className="px-3 py-2"><div title={String(item.part || "")} className="w-full px-1 py-0.5 text-center text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.part || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.weight)} className="w-full px-1 py-0.5 text-center text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.weight}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.completionCriteria || "")} className="w-full px-1 py-0.5 text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.completionCriteria || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.duration || "")} className="w-full px-1 py-0.5 text-center text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.duration || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.questionType || "")} className="w-full px-1 py-0.5 text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.questionType || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.knowledgeSkill || "")} className="w-full px-1 py-0.5 text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.knowledgeSkill || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.gradingGuide || "")} className="w-full px-1 py-0.5 text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.gradingGuide || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.note || "")} className="w-full px-1 py-0.5 text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.note || ""}</div></td>
                                                                <td className="px-3 py-2"><div title={String(item.cloMapping || "")} className="w-full px-1 py-0.5 text-xs opacity-80 line-clamp-2" style={{ wordBreak: 'break-word' }}>{item.cloMapping || ""}</div></td>
                                                            </tr>
