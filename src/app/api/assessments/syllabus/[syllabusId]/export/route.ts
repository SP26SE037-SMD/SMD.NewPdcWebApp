...
export async function GET(
    ...
    try {
        ...
        const backendResponse = await fetch(`${API_BASE_URL}/api/assessments/syllabus/${syllabusId}/export`, {
            method: "GET",
            headers: {
        ...
        return new NextResponse(buffer, {
            ...
            headers: {
                ...
                "Content-Disposition": backendResponse.headers.get("Content-Disposition") || `attachment; filename="Syllabus_${syllabusId}_Assessments.xlsx"`,
            },
        });
    } catch (error) {
