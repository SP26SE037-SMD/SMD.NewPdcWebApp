      ...
      <div className="bg-[#1E293B] text-white py-2 px-6 text-xs flex justify-between items-center tracking-wide">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1 opacity-80">
            <Building2 size={12} /> Academic Quality Control Board
          </span>
        ...
        <section className="relative overflow-hidden bg-white border-b border-zinc-100">
          <div className="container mx-auto px-6 py-24 lg:py-32 flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-8 z-10">
              ...
              >
                SMD is an institutional framework designed to centralize
                curriculum workflows, ensure Bloom's Taxonomy compliance, and
                facilitate automated syllabus versioning for Higher Education
                providers.
              </motion.p>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x border border-zinc-200 rounded-lg overflow-hidden bg-white">
              {[
                ...
                >
                  <span className="text-xs font-bold text-zinc-300 group-hover:text-primary transition-colors">
                    {item.step}
                  </span>
                  <h4 className="font-bold text-zinc-800 mt-4 mb-2">
                    {item.role}
                  </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2 space-y-6">
              ...
              <p className="text-sm leading-relaxed max-w-sm mx-auto md:mx-0">
                Syllabus Management and Digitalization (SMD) is an
                enterprise-grade academic lifecycle management system.
              </p>
            </div>
            <div>
              <h5 className="text-white font-bold text-xs uppercase tracking-[0.2em] mb-6">
                Portal
              </h5>
