...
export const dispatchDecisionCommentUpdate = (
  taskId: string,
  comment: string,
) => {
...
export function FinalDecisionCard({
  ...
  const createSyllabusTaskId =
    createSyllabusTask?.taskId || rawTask?.rootTaskId || taskId || null;
  ...
  const handleCommentChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    if (createSyllabusTaskId && typeof window !== "undefined") {
      localStorage.setItem(
        `final_decision_comment_${createSyllabusTaskId}`,
        newValue,
      );
    ...
    try {
      ...
      const redirectSprintId =
        ...
        (typeof window !== "undefined"
          ? localStorage.getItem("hopdc_last_sprint_id")
          : "") ||
        "";
      const redirectCurriculumId =
        searchParams.get("curriculumId") ||
        createSyllabusTask?.curriculumId ||
        rawTask?.curriculumId ||
        (typeof window !== "undefined"
          ? localStorage.getItem("hopdc_last_curriculum_id")
          : "") ||
        "";
      ...
      if (isHoCFDC) {
        ...
        const effectiveCurrId =
          redirectCurriculumId ||
          createSyllabusTask?.curriculumId ||
          rawTask?.curriculumId;
  ...
  if (
    createSyllabusTask.isAccepted !== null &&
    createSyllabusTask.isAccepted !== undefined
  ) {
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2 pb-2 border-b border-zinc-100">
          <div
            className={`p-1.5 rounded-lg ${isAccepted ? "bg-emerald-100 text-emerald-700" : "bg-rose-100 text-rose-700"}`}
          >
            <AlertCircle size={16} />
          </div>
          <div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-zinc-500 font-medium leading-relaxed">
            A final decision has already been submitted for this syllabus
            deliverable.
          </p>
        </div>
              ...
              decisionComment.split("-").map((item, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-start gap-1">
                    <span className="text-zinc-400 font-bold shrink-0 select-none">
                      •
                    </span>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-zinc-500 font-medium leading-relaxed">
          Review is complete. You can accept this syllabus, or reject it with
          comments to assign an update task.
        </p>
      </div>
