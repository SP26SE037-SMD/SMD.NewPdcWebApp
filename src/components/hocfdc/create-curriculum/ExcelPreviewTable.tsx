                  ...
                  <tr 
                    ...
                    className={`group transition-colors ${
                      isHeaderRow 
                        ? 'font-bold' 
                        : isErrorRow 
                          ? 'bg-rose-50 hover:bg-rose-100/70 relative' 
                          : 'hover:bg-surface-variant/20'
                    }`}
                  >
                    <td className={`border border-outline/10 p-1 text-xs font-medium select-none sticky left-0 z-10 ${
                      isErrorRow ? 'bg-rose-100 text-rose-600 font-bold' : 'bg-surface-container/20 group-hover:bg-surface-variant/40 text-on-surface-variant/60'
                    }`}>
                      ...
                      return (
                        <td 
                          ...
                          className={`border border-outline/10 px-3 py-2 relative text-xs align-top ${
                            ...
                            isErrorRow ? 'bg-rose-50/30 text-rose-700' : ''
                          }`}
