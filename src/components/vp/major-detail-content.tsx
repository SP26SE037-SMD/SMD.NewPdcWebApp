...
export default function MajorDetailContent() {
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      {/* Compact Header */}
      <div className="px-8 py-6 border-b border-zinc-100 bg-white sticky top-0 z-30">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pt-4">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-xs font-black uppercase tracking-[0.2em] px-2.5 py-1 rounded-lg ${
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              {major.status === "INTERNAL_REVIEW" && (
                <button
                  ...
                  className="px-6 py-3 bg-emerald-600 text-white text-xs font-black uppercase tracking-[0.2em] rounded-xl hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/10 active:scale-95 flex items-center gap-2 disabled:opacity-50"
                >
              ...
              <div className="pb-4 pt-2">
                <div className="flex items-center justify-between relative max-w-3xl mx-auto">
                  ...
                  {[
                    ...
                    const isCompleted =
                      ["INTERNAL_REVIEW", "PUBLISHED", "ARCHIVED"].slice(
                        [
                          "DRAFT",
                          "INTERNAL_REVIEW",
                          "PUBLISHED",
                      ...
                      ["INTERNAL_REVIEW", "PUBLISHED", "ARCHIVED"].slice(
                        [
                          ...
                          "PUBLISHED",
                          "ARCHIVED",
                        ].indexOf(major.status),
                      ).length;
                    // Simpler logic for isCompleted:
                    const statusOrder = [
                      "DRAFT",
                      "INTERNAL_REVIEW",
                      "PUBLISHED",
                    ...
                    const currentIndex = statusOrder.indexOf(major.status);
                    ...
                    return (
                      ...
                      >
                        <motion.div
                          animate={{
                            backgroundColor:
                              isPast || isCurrent ? "#10b981" : "#f4f4f5",
                ...
                <div className="pt-6 border-t border-zinc-200/50 flex items-center gap-8">
                  <div className="space-y-1">
                    ...
                    <span className="text-sm font-bold text-zinc-900">
                      {new Date(major.createdAt).toLocaleDateString(undefined, {
                        dateStyle: "long",
                      })}
                    </span>
                  </div>
