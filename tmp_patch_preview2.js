...
function patchSession(filepath) {
    let code = fs.readFileSync(filepath, 'utf8');

    // old list pattern in session:
    ...
    code = code.replace(oldListPattern, newList_session.trim());
    fs.writeFileSync(filepath, code);
}

patchSession('src/app/dashboard/pdcm/tasks/[taskId]/sessions/page.tsx');
